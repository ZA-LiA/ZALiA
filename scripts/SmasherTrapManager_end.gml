...
var _exists = false;
    ...
    _exists=variable_instance_exists(id,"Trap_dg");
if (_exists) _exists = !is_undefined(    Trap_dg);
if (_exists) _exists = ds_exists(        Trap_dg,ds_type_grid);
if (_exists)           ds_grid_destroy(  Trap_dg);
if (_exists)                             Trap_dg=undefined;
