...
//SaveFileRandoInfo_dm[?_datakey2+"_Need"+STR_Surface]
// -------------------------------------------------------
...
&&  val(SaveFileRandoInfo_dm[?"_Need"+STR_Surface]) )
{
    ...
    for(_i=0; _i<SAVE_FILE_MAX; _i++)
    {
        ...
        /*
        if(!is_undefined(      SaveFileRandoInfo_dm[?_datakey0+STR_Rando+STR_Data])) // if this save file is rando'd
        {
        ...
        */
        ...
        {
            _data = SaveFileRandoInfo_dm[?_datakey0+STR_Rando+STR_Data];
